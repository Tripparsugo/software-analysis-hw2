...
public class Player extends Entity {
    ...
    public void setCharacterLevels(HashMap<String, Integer> newCharacterLevels) {
        if (newCharacterLevels == null) {
            throw new NullPointerException("");
        }

        this.characterLevels = new HashMap<>(newCharacterLevels);
    }
    ...
    public int getCharacterLevel(String characterType) {
        if (characterLevels.get(characterType) == null) {
            throw new IllegalArgumentException("character type  does not exist");
        }
        int characterLevel = characterLevels.get(characterType);
